...
namespace GYM_Nutrition_Union.Persistence.Migrations
{
    ...
    [Migration("20250531205059_avgKcalDailyTable")]
    partial class avgKcalDailyTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GYM_Nurition.Domain.Entities.AvgKcalDailyResults", b =>
                {
                    b.Property<int>("AvgKcalDailyResultsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AvgKcalDailyResultsId"));

                    b.Property<int>("AppUserId")
                        .HasColumnType("int");

                    b.Property<decimal>("BurnKcal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("DailyMacro")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("DailyTakenKcal")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateOnly>("Date")
                        .HasColumnType("date");

                    b.Property<decimal>("ResultKcal")
                        .HasColumnType("decimal(18,2)");

                    b.HasKey("AvgKcalDailyResultsId");

                    b.HasIndex("AppUserId");

                    b.ToTable("AvgKcalDailyResults");
                });
            ...
            modelBuilder.Entity("GYM_Nurition.Domain.Entities.AppUser", b =>
                {
                    ...
                    b.Navigation("avgKcalDailyResults");
